...
public class MyConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		loginPage("/login").loginProcessingUrl("/dologin").defaultSuccessUrl("/user/home").and().csrf().disable();
	
		//by defaulturl will redirect to first.html form now. after defaultsuccessurl.
	}
